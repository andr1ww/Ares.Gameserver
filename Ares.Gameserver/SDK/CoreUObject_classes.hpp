...
public:
    ...
    inline UObject* Cast(UClass* OtherClass)
    {
        return IsA(OtherClass) ? this : nullptr;
    }
    template <typename T>
    inline bool IsA()
    {
    ...
    inline void AddToRoot() const
    {
        if (!this)
            return;

        auto Item = (FUObjectItem*)GObjects->GetItemByIndex(Index);
...
static_assert(offsetof(UProperty, ArrayDim) == 0x000038, "Member 'UProperty::ArrayDim' has a wrong offset!");
static_assert(offsetof(UProperty, ElementSize) == 0x00003C, "Member 'UProperty::ElementSize' has a wrong offset!");
static_assert(offsetof(UProperty, PropertyFlags) == 0x000040, "Member 'UProperty::PropertyFlags' has a wrong offset!");
static_assert(offsetof(UProperty, Offset) == 0x00004C, "Member 'UProperty::Offset' has a wrong offset!");
...
static_assert(sizeof(IInterface) == 0x000030, "Wrong size on IInterface");
...
public:
	...
	enum class EClassCastFlags                    CastFlags;                                         // 0x00C0(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(UClass, CastFlags) == 0x0000C0, "Member 'UClass::CastFlags' has a wrong offset!");
static_assert(offsetof(UClass, DefaultObject) == 0x000108, "Member 'UClass::DefaultObject' has a wrong offset!");
...
static_assert(sizeof(USparseDelegateFunction) == 0x0000E8, "Wrong size on USparseDelegateFunction");
...
static_assert(sizeof(UDynamicClass) == 0x000278, "Wrong size on UDynamicClass");
...
{
public:
	class UProperty*                              UnderlayingProperty;                               // 0x0080(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(UEnumProperty, UnderlayingProperty) == 0x000080, "Member 'UEnumProperty::UnderlayingProperty' has a wrong offset!");
static_assert(offsetof(UEnumProperty, Enum) == 0x000088, "Member 'UEnumProperty::Enum' has a wrong offset!");
...
{
public:
	uint8                                         Pad_210[0x1B8];                                    // 0x0210(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_D0[0x1B8];                                     // 0x00D0(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x000288, "Wrong size on ULinkerPlaceholderFunction");
...
static_assert(sizeof(UMetaData) == 0x0000D0, "Wrong size on UMetaData");
...
{
public:
	class UProperty*                              InnerProperty;                                     // 0x0080(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(UArrayProperty, InnerProperty) == 0x000080, "Member 'UArrayProperty::InnerProperty' has a wrong offset!");
...
static_assert(offsetof(UObjectPropertyBase, PropertyClass) == 0x000080, "Member 'UObjectPropertyBase::PropertyClass' has a wrong offset!");
...
static_assert(offsetof(UBoolProperty, FieldSize) == 0x000080, "Member 'UBoolProperty::FieldSize' has a wrong offset!");
static_assert(offsetof(UBoolProperty, ByteOffset) == 0x000081, "Member 'UBoolProperty::ByteOffset' has a wrong offset!");
static_assert(offsetof(UBoolProperty, ByteMask) == 0x000082, "Member 'UBoolProperty::ByteMask' has a wrong offset!");
static_assert(offsetof(UBoolProperty, FieldMask) == 0x000083, "Member 'UBoolProperty::FieldMask' has a wrong offset!");
...
static_assert(offsetof(UByteProperty, Enum) == 0x000080, "Member 'UByteProperty::Enum' has a wrong offset!");
...
static_assert(offsetof(UClassProperty, MetaClass) == 0x000088, "Member 'UClassProperty::MetaClass' has a wrong offset!");
...
static_assert(offsetof(UDelegateProperty, SignatureFunction) == 0x000080, "Member 'UDelegateProperty::SignatureFunction' has a wrong offset!");
...
{
public:
	class UProperty*                              KeyProperty;                                       // 0x0080(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class UProperty*                              ValueProperty;                                     // 0x0088(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(UMapProperty, KeyProperty) == 0x000080, "Member 'UMapProperty::KeyProperty' has a wrong offset!");
static_assert(offsetof(UMapProperty, ValueProperty) == 0x000088, "Member 'UMapProperty::ValueProperty' has a wrong offset!");
...
{
public:
	class UProperty*                              ElementProperty;                                   // 0x0080(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(USetProperty, ElementProperty) == 0x000080, "Member 'USetProperty::ElementProperty' has a wrong offset!");
...
static_assert(offsetof(UStructProperty, Struct) == 0x000080, "Member 'UStructProperty::Struct' has a wrong offset!");
