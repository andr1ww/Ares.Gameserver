...
static_assert(sizeof(ULevelVariantSets) == 0x000098, "Wrong size on ULevelVariantSets");
static_assert(offsetof(ULevelVariantSets, DirectorClass) == 0x000030, "Member 'ULevelVariantSets::DirectorClass' has a wrong offset!");
static_assert(offsetof(ULevelVariantSets, VariantSets) == 0x000038, "Member 'ULevelVariantSets::VariantSets' has a wrong offset!");
...
{
public:
	struct FSoftObjectPath                        LevelVariantSets;                                  // 0x03A8(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ALevelVariantSetsActor) == 0x0003C8, "Wrong size on ALevelVariantSetsActor");
static_assert(offsetof(ALevelVariantSetsActor, LevelVariantSets) == 0x0003A8, "Member 'ALevelVariantSetsActor::LevelVariantSets' has a wrong offset!");
...
public:
	...
	class FName                                   PropertySetterName;                                // 0x00C8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_149[0x7F];                                     // 0x0149(0x007F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPropertyValue) == 0x0001C8, "Wrong size on UPropertyValue");
...
static_assert(sizeof(UPropertyValueTransform) == 0x0001C8, "Wrong size on UPropertyValueTransform");
...
static_assert(sizeof(UPropertyValueVisibility) == 0x0001C8, "Wrong size on UPropertyValueVisibility");
...
static_assert(sizeof(UPropertyValueColor) == 0x0001C8, "Wrong size on UPropertyValueColor");
...
static_assert(sizeof(UPropertyValueMaterial) == 0x0001C8, "Wrong size on UPropertyValueMaterial");
...
static_assert(offsetof(UVariant, DisplayText) == 0x000030, "Member 'UVariant::DisplayText' has a wrong offset!");
static_assert(offsetof(UVariant, ObjectBindings) == 0x000060, "Member 'UVariant::ObjectBindings' has a wrong offset!");
...
{
public:
	struct FSoftObjectPath                        ObjectPtr;                                         // 0x0030(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UVariantObjectBinding, ObjectPtr) == 0x000030, "Member 'UVariantObjectBinding::ObjectPtr' has a wrong offset!");
...
static_assert(offsetof(UVariantSet, DisplayText) == 0x000030, "Member 'UVariantSet::DisplayText' has a wrong offset!");
static_assert(offsetof(UVariantSet, bExpanded) == 0x000060, "Member 'UVariantSet::bExpanded' has a wrong offset!");
static_assert(offsetof(UVariantSet, Variants) == 0x000068, "Member 'UVariantSet::Variants' has a wrong offset!");
