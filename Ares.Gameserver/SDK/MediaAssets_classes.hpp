...
{
public:
	class FName                                   PlayerName;                                        // 0x0038(0x000C)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UBaseMediaSource, PlayerName) == 0x000038, "Member 'UBaseMediaSource::PlayerName' has a wrong offset!");
...
static_assert(sizeof(UFileMediaSource) == 0x000070, "Wrong size on UFileMediaSource");
...
public:
	...
	uint8                                         Pad_6F8[0x1E8];                                    // 0x06F8(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaTexture) == 0x0001A8, "Wrong size on UMediaTexture");
...
{
public:
	bool                                          bUseTimeSynchronization;                           // 0x0048(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTimeSynchronizableMediaSource) == 0x000050, "Wrong size on UTimeSynchronizableMediaSource");
static_assert(offsetof(UTimeSynchronizableMediaSource, bUseTimeSynchronization) == 0x000048, "Member 'UTimeSynchronizableMediaSource::bUseTimeSynchronization' has a wrong offset!");
