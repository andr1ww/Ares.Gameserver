...
public:
	...
	class FName                                   AttachSocketName;                                  // 0x0038(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AttachComponentName;                               // 0x0044(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentLocationRule;                            // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentRotationRule;                            // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AttachmentScaleRule;                               // 0x0052(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentLocationRule;                            // 0x0053(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentRotationRule;                            // 0x0054(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDetachmentRule                               DetachmentScaleRule;                               // 0x0055(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieScene3DAttachSectionTemplate) == 0x000058, "Wrong size on FMovieScene3DAttachSectionTemplate");
...
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, AttachComponentName) == 0x000044, "Member 'FMovieScene3DAttachSectionTemplate::AttachComponentName' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, AttachmentLocationRule) == 0x000050, "Member 'FMovieScene3DAttachSectionTemplate::AttachmentLocationRule' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, AttachmentRotationRule) == 0x000051, "Member 'FMovieScene3DAttachSectionTemplate::AttachmentRotationRule' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, AttachmentScaleRule) == 0x000052, "Member 'FMovieScene3DAttachSectionTemplate::AttachmentScaleRule' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, DetachmentLocationRule) == 0x000053, "Member 'FMovieScene3DAttachSectionTemplate::DetachmentLocationRule' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, DetachmentRotationRule) == 0x000054, "Member 'FMovieScene3DAttachSectionTemplate::DetachmentRotationRule' has a wrong offset!");
static_assert(offsetof(FMovieScene3DAttachSectionTemplate, DetachmentScaleRule) == 0x000055, "Member 'FMovieScene3DAttachSectionTemplate::DetachmentScaleRule' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneObjectPropertyTemplate) == 0x000120, "Wrong size on FMovieSceneObjectPropertyTemplate");
static_assert(offsetof(FMovieSceneObjectPropertyTemplate, ObjectChannel) == 0x000058, "Member 'FMovieSceneObjectPropertyTemplate::ObjectChannel' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneEulerTransformPropertySectionTemplate) == 0x0006A8, "Wrong size on FMovieSceneEulerTransformPropertySectionTemplate");
static_assert(offsetof(FMovieSceneEulerTransformPropertySectionTemplate, TemplateData) == 0x000058, "Member 'FMovieSceneEulerTransformPropertySectionTemplate::TemplateData' has a wrong offset!");
...
{
public:
	class FName                                   FunctionName;                                      // 0x0000(0x000C)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneEvent) == 0x000004, "Wrong alignment on FMovieSceneEvent");
static_assert(sizeof(FMovieSceneEvent) == 0x00000C, "Wrong size on FMovieSceneEvent");
...
static_assert(sizeof(FMovieSceneBoolPropertySectionTemplate) == 0x0000E8, "Wrong size on FMovieSceneBoolPropertySectionTemplate");
static_assert(offsetof(FMovieSceneBoolPropertySectionTemplate, BoolCurve) == 0x000058, "Member 'FMovieSceneBoolPropertySectionTemplate::BoolCurve' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneVisibilitySectionTemplate) == 0x0000E8, "Wrong size on FMovieSceneVisibilitySectionTemplate");
...
static_assert(sizeof(FMovieSceneStringPropertySectionTemplate) == 0x0000F8, "Wrong size on FMovieSceneStringPropertySectionTemplate");
static_assert(offsetof(FMovieSceneStringPropertySectionTemplate, StringCurve) == 0x000058, "Member 'FMovieSceneStringPropertySectionTemplate::StringCurve' has a wrong offset!");
...
public:
	...
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0058(0x00A0)(NativeAccessSpecifierPrivate)
};
...
static_assert(offsetof(FMovieSceneActorReferenceSectionTemplate, ActorReferenceData) == 0x000058, "Member 'FMovieSceneActorReferenceSectionTemplate::ActorReferenceData' has a wrong offset!");
...
public:
	...
	class FName                                   SlotName;                                          // 0x0018(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x0058(0x00A0)(NativeAccessSpecifierPublic)
	EMovieSceneBlendType                          BlendType;                                         // 0x02D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneColorSectionTemplate) == 0x0002E0, "Wrong size on FMovieSceneColorSectionTemplate");
static_assert(offsetof(FMovieSceneColorSectionTemplate, Curves) == 0x000058, "Member 'FMovieSceneColorSectionTemplate::Curves' has a wrong offset!");
static_assert(offsetof(FMovieSceneColorSectionTemplate, BlendType) == 0x0002D8, "Member 'FMovieSceneColorSectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneTransformPropertySectionTemplate) == 0x0006A8, "Wrong size on FMovieSceneTransformPropertySectionTemplate");
static_assert(offsetof(FMovieSceneTransformPropertySectionTemplate, TemplateData) == 0x000058, "Member 'FMovieSceneTransformPropertySectionTemplate::TemplateData' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneEnumPropertySectionTemplate) == 0x0000F0, "Wrong size on FMovieSceneEnumPropertySectionTemplate");
static_assert(offsetof(FMovieSceneEnumPropertySectionTemplate, EnumCurve) == 0x000058, "Member 'FMovieSceneEnumPropertySectionTemplate::EnumCurve' has a wrong offset!");
...
{
public:
	class FName                                   EventToTrigger;                                    // 0x0038(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneEventRepeaterTemplate) == 0x000008, "Wrong alignment on FMovieSceneEventRepeaterTemplate");
static_assert(sizeof(FMovieSceneEventRepeaterTemplate) == 0x000048, "Wrong size on FMovieSceneEventRepeaterTemplate");
...
static_assert(sizeof(FMovieSceneIntegerPropertySectionTemplate) == 0x0000F0, "Wrong size on FMovieSceneIntegerPropertySectionTemplate");
static_assert(offsetof(FMovieSceneIntegerPropertySectionTemplate, IntegerCurve) == 0x000058, "Member 'FMovieSceneIntegerPropertySectionTemplate::IntegerCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerPropertySectionTemplate, BlendType) == 0x0000E8, "Member 'FMovieSceneIntegerPropertySectionTemplate::BlendType' has a wrong offset!");
...
{
public:
	struct FMovieSceneFloatChannel                ComponentCurves[0x4];                              // 0x0058(0x00A0)(Protected, NativeAccessSpecifierProtected)
	int32                                         NumChannelsUsed;                                   // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EMovieSceneBlendType                          BlendType;                                         // 0x02DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FMovieSceneVectorPropertySectionTemplate) == 0x0002E0, "Wrong size on FMovieSceneVectorPropertySectionTemplate");
static_assert(offsetof(FMovieSceneVectorPropertySectionTemplate, ComponentCurves) == 0x000058, "Member 'FMovieSceneVectorPropertySectionTemplate::ComponentCurves' has a wrong offset!");
static_assert(offsetof(FMovieSceneVectorPropertySectionTemplate, NumChannelsUsed) == 0x0002D8, "Member 'FMovieSceneVectorPropertySectionTemplate::NumChannelsUsed' has a wrong offset!");
static_assert(offsetof(FMovieSceneVectorPropertySectionTemplate, BlendType) == 0x0002DC, "Member 'FMovieSceneVectorPropertySectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneBytePropertySectionTemplate) == 0x0000F0, "Wrong size on FMovieSceneBytePropertySectionTemplate");
static_assert(offsetof(FMovieSceneBytePropertySectionTemplate, ByteCurve) == 0x000058, "Member 'FMovieSceneBytePropertySectionTemplate::ByteCurve' has a wrong offset!");
...
public:
	...
	EMovieSceneBlendType                          BlendType;                                         // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FMovieSceneFloatPropertySectionTemplate) == 0x000100, "Wrong size on FMovieSceneFloatPropertySectionTemplate");
static_assert(offsetof(FMovieSceneFloatPropertySectionTemplate, FloatFunction) == 0x000058, "Member 'FMovieSceneFloatPropertySectionTemplate::FloatFunction' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatPropertySectionTemplate, BlendType) == 0x0000F8, "Member 'FMovieSceneFloatPropertySectionTemplate::BlendType' has a wrong offset!");
