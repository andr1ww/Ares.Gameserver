...
static_assert(sizeof(FPaperTileMetadata) == 0x000048, "Wrong size on FPaperTileMetadata");
...
static_assert(offsetof(FPaperTileMetadata, CollisionData) == 0x000010, "Member 'FPaperTileMetadata::CollisionData' has a wrong offset!");
static_assert(offsetof(FPaperTileMetadata, TerrainMembership) == 0x000040, "Member 'FPaperTileMetadata::TerrainMembership' has a wrong offset!");
