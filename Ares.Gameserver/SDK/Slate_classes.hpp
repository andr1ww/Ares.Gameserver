...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0038(0x0428)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x000460, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0038(0x03E0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x000418, "Wrong size on UComboButtonWidgetStyle");
...
static_assert(sizeof(UProgressWidgetStyle) == 0x0001F0, "Wrong size on UProgressWidgetStyle");
