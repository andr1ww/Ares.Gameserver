...
static_assert(offsetof(FAkAdvancedInitializationSettings, TargetAutoStreamBufferLength) == 0x000004, "Member 'FAkAdvancedInitializationSettings::TargetAutoStreamBufferLength' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, UseStreamCache) == 0x000008, "Member 'FAkAdvancedInitializationSettings::UseStreamCache' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, MaximumPinnedBytesInCache) == 0x00000C, "Member 'FAkAdvancedInitializationSettings::MaximumPinnedBytesInCache' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, PrepareEventMemoryPoolID) == 0x000010, "Member 'FAkAdvancedInitializationSettings::PrepareEventMemoryPoolID' has a wrong offset!");
...
static_assert(offsetof(FAkAdvancedInitializationSettings, MonitorPoolSize) == 0x00001C, "Member 'FAkAdvancedInitializationSettings::MonitorPoolSize' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, MonitorQueuePoolSize) == 0x000020, "Member 'FAkAdvancedInitializationSettings::MonitorQueuePoolSize' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, MaximumHardwareTimeoutMs) == 0x000024, "Member 'FAkAdvancedInitializationSettings::MaximumHardwareTimeoutMs' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettings, SpatialAudioSettings) == 0x000028, "Member 'FAkAdvancedInitializationSettings::SpatialAudioSettings' has a wrong offset!");
...
static_assert(sizeof(FAkAdvancedInitializationSettingsWithMultiCoreRendering) == 0x000034, "Wrong size on FAkAdvancedInitializationSettingsWithMultiCoreRendering");
...
static_assert(sizeof(FAkWindowsAdvancedInitializationSettings) == 0x00003C, "Wrong size on FAkWindowsAdvancedInitializationSettings");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, AudioAPI) == 0x000034, "Member 'FAkWindowsAdvancedInitializationSettings::AudioAPI' has a wrong offset!");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, GlobalFocus) == 0x000038, "Member 'FAkWindowsAdvancedInitializationSettings::GlobalFocus' has a wrong offset!");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x000039, "Member 'FAkWindowsAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
...
static_assert(sizeof(FAkSpatialAudioSettings) == 0x000010, "Wrong size on FAkSpatialAudioSettings");
static_assert(offsetof(FAkSpatialAudioSettings, SpatialAudioPoolSize) == 0x000000, "Member 'FAkSpatialAudioSettings::SpatialAudioPoolSize' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MaxSoundPropagationDepth) == 0x000004, "Member 'FAkSpatialAudioSettings::MaxSoundPropagationDepth' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, DiffractionFlags) == 0x000008, "Member 'FAkSpatialAudioSettings::DiffractionFlags' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MovementThreshold) == 0x00000C, "Member 'FAkSpatialAudioSettings::MovementThreshold' has a wrong offset!");
...
static_assert(offsetof(FAkCommonInitializationSettings, DefaultPoolSize) == 0x000008, "Member 'FAkCommonInitializationSettings::DefaultPoolSize' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, MemoryCutoffThreshold) == 0x00000C, "Member 'FAkCommonInitializationSettings::MemoryCutoffThreshold' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, CommandQueueSize) == 0x000010, "Member 'FAkCommonInitializationSettings::CommandQueueSize' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, SamplesPerFrame) == 0x000014, "Member 'FAkCommonInitializationSettings::SamplesPerFrame' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, MainOutputSettings) == 0x000018, "Member 'FAkCommonInitializationSettings::MainOutputSettings' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, StreamingLookAheadRatio) == 0x000040, "Member 'FAkCommonInitializationSettings::StreamingLookAheadRatio' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, StreamManagerPoolSize) == 0x000044, "Member 'FAkCommonInitializationSettings::StreamManagerPoolSize' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, LowerEnginePoolSize) == 0x000048, "Member 'FAkCommonInitializationSettings::LowerEnginePoolSize' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, LowerEngineMemoryCutoffThreshold) == 0x00004C, "Member 'FAkCommonInitializationSettings::LowerEngineMemoryCutoffThreshold' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, NumberOfRefillsInVoice) == 0x000050, "Member 'FAkCommonInitializationSettings::NumberOfRefillsInVoice' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, SpatialAudioSettings) == 0x000054, "Member 'FAkCommonInitializationSettings::SpatialAudioSettings' has a wrong offset!");
...
struct FAkChannelEmitter final
{
public:
	...
	int32                                         Channels;                                          // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAkChannelEmitter) == 0x000004, "Wrong alignment on FAkChannelEmitter");
static_assert(sizeof(FAkChannelEmitter) == 0x00001C, "Wrong size on FAkChannelEmitter");
static_assert(offsetof(FAkChannelEmitter, Position) == 0x000000, "Member 'FAkChannelEmitter::Position' has a wrong offset!");
static_assert(offsetof(FAkChannelEmitter, Rotation) == 0x00000C, "Member 'FAkChannelEmitter::Rotation' has a wrong offset!");
static_assert(offsetof(FAkChannelEmitter, Channels) == 0x000018, "Member 'FAkChannelEmitter::Channels' has a wrong offset!");
...
static_assert(sizeof(FAkExternalSourceInfo) == 0x000028, "Wrong size on FAkExternalSourceInfo");
...
static_assert(sizeof(FAkPS4AdvancedInitializationSettings) == 0x00003C, "Wrong size on FAkPS4AdvancedInitializationSettings");
static_assert(offsetof(FAkPS4AdvancedInitializationSettings, ACPBatchBufferSize) == 0x000034, "Member 'FAkPS4AdvancedInitializationSettings::ACPBatchBufferSize' has a wrong offset!");
static_assert(offsetof(FAkPS4AdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x000038, "Member 'FAkPS4AdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
...
static_assert(offsetof(FAkXBoxOneAdvancedInitializationSettings, ShapeDefaultPoolSize) == 0x000034, "Member 'FAkXBoxOneAdvancedInitializationSettings::ShapeDefaultPoolSize' has a wrong offset!");
