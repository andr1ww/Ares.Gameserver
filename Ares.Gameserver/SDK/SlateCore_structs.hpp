...
public:
	...
	int32                                         Tracking;                                          // 0x0050(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FSlateFontInfo, Tracking) == 0x000050, "Member 'FSlateFontInfo::Tracking' has a wrong offset!");
...
public:
	...
	struct FMargin                                MenuBorderPadding;                                 // 0x03D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FComboButtonStyle) == 0x000008, "Wrong alignment on FComboButtonStyle");
static_assert(sizeof(FComboButtonStyle) == 0x0003E0, "Wrong size on FComboButtonStyle");
...
public:
	...
	struct FSlateSound                            PressedSlateSound;                                 // 0x03E8(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateSound                            SelectionChangeSlateSound;                         // 0x0408(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FComboBoxStyle, SelectionChangeSlateSound) == 0x000408, "Member 'FComboBoxStyle::SelectionChangeSlateSound' has a wrong offset!");
