...
public:
	...
	struct FGameplayAttribute                     ModifyingAttribute;                                // 0x0100(0x0020)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                EffectSource;                                      // 0x0120(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UGameplayEffect>            EffectDefinition;                                  // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayEffectQuery) == 0x000140, "Wrong size on FGameplayEffectQuery");
...
static_assert(offsetof(FGameplayEffectQuery, EffectSource) == 0x000120, "Member 'FGameplayEffectQuery::EffectSource' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectDefinition) == 0x000128, "Member 'FGameplayEffectQuery::EffectDefinition' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 Parameters;                                        // 0x0030(0x00C0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FActiveGameplayCue) == 0x0000F8, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x0000F0, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");
...
public:
	...
	struct FPredictionKey                         PredictionKey;                                     // 0x0020(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayCuePayloadType                       PayloadType;                                       // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                OwningComponent;                                   // 0x0040(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayEffectSpecForRPC              FromSpec;                                          // 0x0048(0x0078)(NativeAccessSpecifierPublic)
	struct FGameplayCueParameters                 CueParameters;                                     // 0x00C0(0x00C0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCuePendingExecute) == 0x000008, "Wrong alignment on FGameplayCuePendingExecute");
static_assert(sizeof(FGameplayCuePendingExecute) == 0x000180, "Wrong size on FGameplayCuePendingExecute");
...
static_assert(offsetof(FGameplayCuePendingExecute, PayloadType) == 0x000038, "Member 'FGameplayCuePendingExecute::PayloadType' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, OwningComponent) == 0x000040, "Member 'FGameplayCuePendingExecute::OwningComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, FromSpec) == 0x000048, "Member 'FGameplayCuePendingExecute::FromSpec' has a wrong offset!");
static_assert(offsetof(FGameplayCuePendingExecute, CueParameters) == 0x0000C0, "Member 'FGameplayCuePendingExecute::CueParameters' has a wrong offset!");
...
// 0x0088 (0x0088 - 0x0000)
struct FFloatCurveFloat final
{
public:
	struct FRuntimeFloatCurve                     Curve;                                             // 0x0000(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFloatCurveFloat) == 0x000008, "Wrong alignment on FFloatCurveFloat");
static_assert(sizeof(FFloatCurveFloat) == 0x000088, "Wrong size on FFloatCurveFloat");
static_assert(offsetof(FFloatCurveFloat, Curve) == 0x000000, "Member 'FFloatCurveFloat::Curve' has a wrong offset!");
...
public:
	...
	struct FCurveTableRowHandle                   AttributeCurve;                                    // 0x00A0(0x0018)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttributeBasedFloatCalculationType           AttributeCalculationType;                          // 0x00B8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayModEvaluationChannel                 FinalChannel;                                      // 0x00B9(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BA[0x6];                                       // 0x00BA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  SourceTagFilter;                                   // 0x00C0(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  TargetTagFilter;                                   // 0x00E0(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAttributeBasedFloat) == 0x000008, "Wrong alignment on FAttributeBasedFloat");
static_assert(sizeof(FAttributeBasedFloat) == 0x000100, "Wrong size on FAttributeBasedFloat");
...
static_assert(offsetof(FAttributeBasedFloat, AttributeCalculationType) == 0x0000B8, "Member 'FAttributeBasedFloat::AttributeCalculationType' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, FinalChannel) == 0x0000B9, "Member 'FAttributeBasedFloat::FinalChannel' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, SourceTagFilter) == 0x0000C0, "Member 'FAttributeBasedFloat::SourceTagFilter' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, TargetTagFilter) == 0x0000E0, "Member 'FAttributeBasedFloat::TargetTagFilter' has a wrong offset!");
...
public:
	...
	struct FAttributeBasedFloat                   AttributeBasedMagnitude;                           // 0x0030(0x0100)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FCustomCalculationBasedFloat           CustomMagnitude;                                   // 0x0130(0x0098)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FSetByCallerFloat                      SetByCallerMagnitude;                              // 0x01C8(0x0018)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FFloatCurveFloat                       FloatCurveMagnitude;                               // 0x01E0(0x0088)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayEffectModifierMagnitude) == 0x000008, "Wrong alignment on FGameplayEffectModifierMagnitude");
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x000268, "Wrong size on FGameplayEffectModifierMagnitude");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, CustomMagnitude) == 0x000130, "Member 'FGameplayEffectModifierMagnitude::CustomMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByCallerMagnitude) == 0x0001C8, "Member 'FGameplayEffectModifierMagnitude::SetByCallerMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, FloatCurveMagnitude) == 0x0001E0, "Member 'FGameplayEffectModifierMagnitude::FloatCurveMagnitude' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0030(0x0268)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x0298(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_299[0x7];                                      // 0x0299(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x02A0(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x02E0(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x000320, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x000298, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x0002A0, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x0002E0, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000098, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
...
static_assert(sizeof(FGameplayModifierInfo) == 0x000340, "Wrong size on FGameplayModifierInfo");
...
static_assert(offsetof(FGameplayModifierInfo, EvaluationChannelSettings) == 0x0002B8, "Member 'FGameplayModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, SourceTags) == 0x0002C0, "Member 'FGameplayModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000300, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UProperty*                              PropertyToEdit;                                    // 0x0010(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PropertyName;                                      // 0x0018(0x000C)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  PropertyGuid;                                      // 0x0024(0x0010)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayTagBlueprintPropertyMapping) == 0x000040, "Wrong size on FGameplayTagBlueprintPropertyMapping");
...
static_assert(offsetof(FGameplayTagBlueprintPropertyMapping, PropertyName) == 0x000018, "Member 'FGameplayTagBlueprintPropertyMapping::PropertyName' has a wrong offset!");
static_assert(offsetof(FGameplayTagBlueprintPropertyMapping, PropertyGuid) == 0x000024, "Member 'FGameplayTagBlueprintPropertyMapping::PropertyGuid' has a wrong offset!");
