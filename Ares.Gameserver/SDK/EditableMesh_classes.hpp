...
{
public:
	uint8                                         Pad_30[0x300];                                     // 0x0030(0x0300)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UEditableMeshAdapter*>           Adapters;                                          // 0x0330(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_340[0x8];                                      // 0x0340(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TextureCoordinateCount;                            // 0x0348(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34C[0x148];                                    // 0x034C(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PendingCompactCounter;                             // 0x0494(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SubdivisionCount;                                  // 0x0498(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49C[0x1E4];                                    // 0x049C(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UEditableMesh, Adapters) == 0x000330, "Member 'UEditableMesh::Adapters' has a wrong offset!");
static_assert(offsetof(UEditableMesh, TextureCoordinateCount) == 0x000348, "Member 'UEditableMesh::TextureCoordinateCount' has a wrong offset!");
static_assert(offsetof(UEditableMesh, PendingCompactCounter) == 0x000494, "Member 'UEditableMesh::PendingCompactCounter' has a wrong offset!");
static_assert(offsetof(UEditableMesh, SubdivisionCount) == 0x000498, "Member 'UEditableMesh::SubdivisionCount' has a wrong offset!");
