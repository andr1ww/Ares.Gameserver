...
// Function UMG.Widget.SetQuality
// 0x0001 (0x0001 - 0x0000)
struct Widget_SetQuality final
{
public:
	ESlateQuality                                 InQuality;                                         // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_SetQuality) == 0x000001, "Wrong alignment on Widget_SetQuality");
static_assert(sizeof(Widget_SetQuality) == 0x000001, "Wrong size on Widget_SetQuality");
static_assert(offsetof(Widget_SetQuality, InQuality) == 0x000000, "Member 'Widget_SetQuality::InQuality' has a wrong offset!");
...
// Function UMG.Widget.SetTagOverride
// 0x000C (0x000C - 0x0000)
struct Widget_SetTagOverride final
{
public:
	class FName                                   InTag;                                             // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_SetTagOverride) == 0x000004, "Wrong alignment on Widget_SetTagOverride");
static_assert(sizeof(Widget_SetTagOverride) == 0x00000C, "Wrong size on Widget_SetTagOverride");
static_assert(offsetof(Widget_SetTagOverride, InTag) == 0x000000, "Member 'Widget_SetTagOverride::InTag' has a wrong offset!");
...
// Function UMG.Widget.GetQuality
// 0x0001 (0x0001 - 0x0000)
struct Widget_GetQuality final
{
public:
	ESlateQuality                                 ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_GetQuality) == 0x000001, "Wrong alignment on Widget_GetQuality");
static_assert(sizeof(Widget_GetQuality) == 0x000001, "Wrong size on Widget_GetQuality");
static_assert(offsetof(Widget_GetQuality, ReturnValue) == 0x000000, "Member 'Widget_GetQuality::ReturnValue' has a wrong offset!");
...
static_assert(alignof(TextBlock_SetWrapTextAt) == 0x000004, "Wrong alignment on TextBlock_SetWrapTextAt");
static_assert(sizeof(TextBlock_SetWrapTextAt) == 0x000004, "Wrong size on TextBlock_SetWrapTextAt");
static_assert(offsetof(TextBlock_SetWrapTextAt, InWrapTextAt) == 0x000000, "Member 'TextBlock_SetWrapTextAt::InWrapTextAt' has a wrong offset!");
...
// Function UMG.BackgroundBlur.SetMaskImage
// 0x0090 (0x0090 - 0x0000)
struct BackgroundBlur_SetMaskImage final
{
public:
	struct FSlateBrush                            InBrush;                                           // 0x0000(0x0090)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(BackgroundBlur_SetMaskImage) == 0x000008, "Wrong alignment on BackgroundBlur_SetMaskImage");
static_assert(sizeof(BackgroundBlur_SetMaskImage) == 0x000090, "Wrong size on BackgroundBlur_SetMaskImage");
static_assert(offsetof(BackgroundBlur_SetMaskImage, InBrush) == 0x000000, "Member 'BackgroundBlur_SetMaskImage::InBrush' has a wrong offset!");
...
// Function UMG.BackgroundBlur.SetTint
// 0x0010 (0x0010 - 0x0000)
struct BackgroundBlur_SetTint final
{
public:
	struct FLinearColor                           InTint;                                            // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BackgroundBlur_SetTint) == 0x000004, "Wrong alignment on BackgroundBlur_SetTint");
static_assert(sizeof(BackgroundBlur_SetTint) == 0x000010, "Wrong size on BackgroundBlur_SetTint");
static_assert(offsetof(BackgroundBlur_SetTint, InTint) == 0x000000, "Member 'BackgroundBlur_SetTint::InTint' has a wrong offset!");
...
// Function UMG.EditableTextBox.GetContentSize
// 0x0008 (0x0008 - 0x0000)
struct EditableTextBox_GetContentSize final
{
public:
	struct FVector2D                              ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EditableTextBox_GetContentSize) == 0x000004, "Wrong alignment on EditableTextBox_GetContentSize");
static_assert(sizeof(EditableTextBox_GetContentSize) == 0x000008, "Wrong size on EditableTextBox_GetContentSize");
static_assert(offsetof(EditableTextBox_GetContentSize, ReturnValue) == 0x000000, "Member 'EditableTextBox_GetContentSize::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RichTextBlock_SetJustification, InJustification) == 0x000000, "Member 'RichTextBlock_SetJustification::InJustification' has a wrong offset!");
...
static_assert(offsetof(RichTextBlock_SetWrapTextAt, InWrapTextAt) == 0x000000, "Member 'RichTextBlock_SetWrapTextAt::InWrapTextAt' has a wrong offset!");
