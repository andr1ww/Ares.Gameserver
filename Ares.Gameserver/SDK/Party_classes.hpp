...
public:
	...
	uint8                                         Pad_68[0x2];                                       // 0x0068(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLeavePartyOnDisconnect;                           // 0x006A(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_6B[0x13D];                                     // 0x006B(0x013D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USocialManager, bLeavePartyOnDisconnect) == 0x00006A, "Member 'USocialManager::bLeavePartyOnDisconnect' has a wrong offset!");
...
public:
	...
	TMap<struct FUniqueNetIdRepl, class UPartyMember*> PartyMembersById;                                  // 0x00D0(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_121[0x7F];                                     // 0x0121(0x007F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C0[0x100];                                    // 0x01C0(0x0100)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USocialParty, CurrentLeaderId) == 0x0000A8, "Member 'USocialParty::CurrentLeaderId' has a wrong offset!");
static_assert(offsetof(USocialParty, PartyMembersById) == 0x0000D0, "Member 'USocialParty::PartyMembersById' has a wrong offset!");
static_assert(offsetof(USocialParty, bEnableAutomaticPartyRejoin) == 0x000120, "Member 'USocialParty::bEnableAutomaticPartyRejoin' has a wrong offset!");
static_assert(offsetof(USocialParty, ReservationBeaconClient) == 0x0001A0, "Member 'USocialParty::ReservationBeaconClient' has a wrong offset!");
static_assert(offsetof(USocialParty, SpectatorBeaconClient) == 0x0001B8, "Member 'USocialParty::SpectatorBeaconClient' has a wrong offset!");
...
static_assert(sizeof(USocialToolkit) == 0x0001D0, "Wrong size on USocialToolkit");
...
public:
	...
	TMap<TWeakObjectPtr<class USocialUser>, class USocialPrivateMessageChannel*> DirectChannelsByTargetUser;                        // 0x0080(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FString, class USocialChatRoom*>   ChatRoomsById;                                     // 0x00D0(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FString, class USocialReadOnlyChatChannel*> ReadOnlyChannelsByDisplayName;                     // 0x0120(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*> GroupChannels;                                     // 0x0178(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USocialUser) == 0x000158, "Wrong size on USocialUser");
