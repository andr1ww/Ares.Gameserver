...
{
public:
	TSubclassOf<class UProperty>                  PropertyType;                                      // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	ETeamAttitude                                 Attitude;                                          // 0x0018(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FActorPerceptionBlueprintInfo, Attitude) == 0x000018, "Member 'FActorPerceptionBlueprintInfo::Attitude' has a wrong offset!");
