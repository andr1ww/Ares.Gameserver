...
{
public:
	TSet<class FString>                           StrSet;                                            // 0x0000(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<int32>                                   IntSet;                                            // 0x0050(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<class FName>                             NameSet;                                           // 0x00A0(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<struct FStructSerializerBuiltinTestStruct> StructSet;                                         // 0x00F0(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FStructSerializerArrayTestStruct) == 0x000050, "Wrong size on FStructSerializerArrayTestStruct");
...
static_assert(offsetof(FStructSerializerArrayTestStruct, StructArray) == 0x000040, "Member 'FStructSerializerArrayTestStruct::StructArray' has a wrong offset!");
...
public:
	...
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x01A0(0x0050)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x01F0(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct         Sets;                                              // 0x0330(0x0140)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerTestStruct) == 0x000010, "Wrong alignment on FStructSerializerTestStruct");
static_assert(sizeof(FStructSerializerTestStruct) == 0x000470, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x0001F0, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x000330, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
