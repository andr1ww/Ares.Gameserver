...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, bFoundID) == 0x00001C, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::bFoundID' has a wrong offset!");
...
static_assert(sizeof(AchievementBlueprintLibrary_GetCachedAchievementProgress) == 0x000028, "Wrong size on AchievementBlueprintLibrary_GetCachedAchievementProgress");
...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementProgress, bFoundID) == 0x00001C, "Member 'AchievementBlueprintLibrary_GetCachedAchievementProgress::bFoundID' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementProgress, Progress) == 0x000020, "Member 'AchievementBlueprintLibrary_GetCachedAchievementProgress::Progress' has a wrong offset!");
...
static_assert(sizeof(AchievementWriteCallbackProxy_WriteAchievementProgress) == 0x000030, "Wrong size on AchievementWriteCallbackProxy_WriteAchievementProgress");
...
static_assert(offsetof(AchievementWriteCallbackProxy_WriteAchievementProgress, Progress) == 0x00001C, "Member 'AchievementWriteCallbackProxy_WriteAchievementProgress::Progress' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteAchievementProgress, UserTag) == 0x000020, "Member 'AchievementWriteCallbackProxy_WriteAchievementProgress::UserTag' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteAchievementProgress, ReturnValue) == 0x000028, "Member 'AchievementWriteCallbackProxy_WriteAchievementProgress::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(LeaderboardBlueprintLibrary_WriteLeaderboardInteger) == 0x000020, "Wrong size on LeaderboardBlueprintLibrary_WriteLeaderboardInteger");
...
static_assert(offsetof(LeaderboardBlueprintLibrary_WriteLeaderboardInteger, StatValue) == 0x000014, "Member 'LeaderboardBlueprintLibrary_WriteLeaderboardInteger::StatValue' has a wrong offset!");
static_assert(offsetof(LeaderboardBlueprintLibrary_WriteLeaderboardInteger, ReturnValue) == 0x000018, "Member 'LeaderboardBlueprintLibrary_WriteLeaderboardInteger::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(LeaderboardFlushCallbackProxy_CreateProxyObjectForFlush) == 0x000020, "Wrong size on LeaderboardFlushCallbackProxy_CreateProxyObjectForFlush");
...
static_assert(offsetof(LeaderboardFlushCallbackProxy_CreateProxyObjectForFlush, ReturnValue) == 0x000018, "Member 'LeaderboardFlushCallbackProxy_CreateProxyObjectForFlush::ReturnValue' has a wrong offset!");
