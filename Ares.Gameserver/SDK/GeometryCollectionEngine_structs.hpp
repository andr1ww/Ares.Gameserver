...
public:
	...
	int32                                         ParticleIndex;                                     // 0x0044(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LevelsetIndex;                                     // 0x0048(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChaosCollisionEventData) == 0x000004, "Wrong alignment on FChaosCollisionEventData");
static_assert(sizeof(FChaosCollisionEventData) == 0x00004C, "Wrong size on FChaosCollisionEventData");
...
static_assert(offsetof(FChaosCollisionEventData, ParticleIndex) == 0x000044, "Member 'FChaosCollisionEventData::ParticleIndex' has a wrong offset!");
static_assert(offsetof(FChaosCollisionEventData, LevelsetIndex) == 0x000048, "Member 'FChaosCollisionEventData::LevelsetIndex' has a wrong offset!");
