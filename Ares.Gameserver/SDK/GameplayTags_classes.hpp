...
public:
	...
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0158(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayTagsManager) == 0x0001B8, "Wrong size on UGameplayTagsManager");
...
static_assert(offsetof(UGameplayTagsManager, GameplayTagTables) == 0x000158, "Member 'UGameplayTagsManager::GameplayTagTables' has a wrong offset!");
...
static_assert(sizeof(UGameplayTagsDeveloperSettings) == 0x000040, "Wrong size on UGameplayTagsDeveloperSettings");
static_assert(offsetof(UGameplayTagsDeveloperSettings, DeveloperConfigName) == 0x000030, "Member 'UGameplayTagsDeveloperSettings::DeveloperConfigName' has a wrong offset!");
