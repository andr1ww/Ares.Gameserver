...
{
public:
	struct FMovieSceneFloatChannel                Translation[0x2];                                  // 0x0058(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Rotation;                                          // 0x0198(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Scale[0x2];                                        // 0x0238(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Shear[0x2];                                        // 0x0378(0x00A0)(NativeAccessSpecifierPrivate)
	EMovieSceneBlendType                          BlendType;                                         // 0x04B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4B9[0x3];                                      // 0x04B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieScene2DTransformMask             Mask;                                              // 0x04BC(0x0004)(NoDestructor, NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieScene2DTransformSectionTemplate) == 0x0004C0, "Wrong size on FMovieScene2DTransformSectionTemplate");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Translation) == 0x000058, "Member 'FMovieScene2DTransformSectionTemplate::Translation' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Rotation) == 0x000198, "Member 'FMovieScene2DTransformSectionTemplate::Rotation' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Scale) == 0x000238, "Member 'FMovieScene2DTransformSectionTemplate::Scale' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Shear) == 0x000378, "Member 'FMovieScene2DTransformSectionTemplate::Shear' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, BlendType) == 0x0004B8, "Member 'FMovieScene2DTransformSectionTemplate::BlendType' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Mask) == 0x0004BC, "Member 'FMovieScene2DTransformSectionTemplate::Mask' has a wrong offset!");
...
{
public:
	struct FMovieSceneFloatChannel                TopCurve;                                          // 0x0058(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                LeftCurve;                                         // 0x00F8(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                RightCurve;                                        // 0x0198(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BottomCurve;                                       // 0x0238(0x00A0)(NativeAccessSpecifierPrivate)
	EMovieSceneBlendType                          BlendType;                                         // 0x02D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneMarginSectionTemplate) == 0x0002E0, "Wrong size on FMovieSceneMarginSectionTemplate");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, TopCurve) == 0x000058, "Member 'FMovieSceneMarginSectionTemplate::TopCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, LeftCurve) == 0x0000F8, "Member 'FMovieSceneMarginSectionTemplate::LeftCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, RightCurve) == 0x000198, "Member 'FMovieSceneMarginSectionTemplate::RightCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, BottomCurve) == 0x000238, "Member 'FMovieSceneMarginSectionTemplate::BottomCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, BlendType) == 0x0002D8, "Member 'FMovieSceneMarginSectionTemplate::BlendType' has a wrong offset!");
