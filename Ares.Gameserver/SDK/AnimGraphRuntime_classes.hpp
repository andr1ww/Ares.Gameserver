...
static_assert(sizeof(UAnimCustomInstance) == 0x0002B0, "Wrong size on UAnimCustomInstance");
...
static_assert(sizeof(UAnimSequencerInstance) == 0x0002B0, "Wrong size on UAnimSequencerInstance");
