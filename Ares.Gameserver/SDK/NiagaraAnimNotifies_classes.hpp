...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffect) == 0x000068, "Wrong size on UAnimNotifyState_TimedNiagaraEffect");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, LocationOffset) == 0x00004C, "Member 'UAnimNotifyState_TimedNiagaraEffect::LocationOffset' has a wrong offset!");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bDestroyAtEnd) == 0x000064, "Member 'UAnimNotifyState_TimedNiagaraEffect::bDestroyAtEnd' has a wrong offset!");
