...
public:
	...
	struct FSoftClassPath                         SignificanceManagerClassName;                      // 0x0108(0x0020)(Edit, ZeroConstructor, Config, GlobalConfig, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USignificanceManager) == 0x000128, "Wrong size on USignificanceManager");
