...
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FRandomStream final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         InitialSeed;                                       // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Seed;                                              // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRandomStream) == 0x000008, "Wrong alignment on FRandomStream");
static_assert(sizeof(FRandomStream) == 0x000018, "Wrong size on FRandomStream");
static_assert(offsetof(FRandomStream, InitialSeed) == 0x000010, "Member 'FRandomStream::InitialSeed' has a wrong offset!");
static_assert(offsetof(FRandomStream, Seed) == 0x000014, "Member 'FRandomStream::Seed' has a wrong offset!");
