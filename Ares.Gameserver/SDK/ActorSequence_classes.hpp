...
{
public:
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0108(0x0014)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UActorSequencePlayer) == 0x000820, "Wrong size on UActorSequencePlayer");
