...
public:
	...
	TMap<class ULandscapeLayerInfoObject*, bool>  WeightmapLayerAllocationBlend;                     // 0x0040(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FLandscapeEditToolRenderData) == 0x000030, "Wrong size on FLandscapeEditToolRenderData");
