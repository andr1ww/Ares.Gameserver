...
public:
	...
	EMaskTarget_PhysMesh                          CurrentTarget;                                     // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FClothParameterMask_PhysMesh, CurrentTarget) == 0x00000C, "Member 'FClothParameterMask_PhysMesh::CurrentTarget' has a wrong offset!");
static_assert(offsetof(FClothParameterMask_PhysMesh, MaxValue) == 0x000010, "Member 'FClothParameterMask_PhysMesh::MaxValue' has a wrong offset!");
static_assert(offsetof(FClothParameterMask_PhysMesh, MinValue) == 0x000014, "Member 'FClothParameterMask_PhysMesh::MinValue' has a wrong offset!");
