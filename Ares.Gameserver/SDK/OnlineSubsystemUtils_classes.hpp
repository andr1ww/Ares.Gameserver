...
static_assert(sizeof(UAchievementBlueprintLibrary) == 0x000030, "Wrong size on UAchievementBlueprintLibrary");
...
static_assert(sizeof(ULogoutCallbackProxy) == 0x000070, "Wrong size on ULogoutCallbackProxy");
static_assert(offsetof(ULogoutCallbackProxy, OnSuccess) == 0x000038, "Member 'ULogoutCallbackProxy::OnSuccess' has a wrong offset!");
...
public:
	...
	float                                         BeaconConnectionInitialTimeout;                    // 0x03B0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BeaconConnectionTimeout;                           // 0x03B4(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetDriver*                             NetDriver;                                         // 0x03B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeacon) == 0x0003E0, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x0003B0, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x0003B4, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x0003B8, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
{
public:
	int32                                         ListenPort;                                        // 0x03E0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3E4[0x4];                                      // 0x03E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x03E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000498, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x0003E0, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x0003E8, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x03E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x03E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EBeaconConnectionState                        ConnectionState;                                   // 0x03F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3F1[0x3F];                                     // 0x03F1(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000430, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0003E0, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0003E8, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0003F0, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
{
public:
	class FString                                 BeaconTypeName;                                    // 0x03A8(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x03B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x03C0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x0003D0, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x0003A8, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x0003B8, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x0003C0, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseState CompletionStatus, struct FInAppPurchaseProductInfo& InAppPurchaseInformation)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(EInAppPurchaseState CompletionStatus, struct FInAppPurchaseProductInfo& InAppPurchaseInformation)> OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x38];                                      // 0x0050(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInAppPurchaseCallbackProxy) == 0x000088, "Wrong size on UInAppPurchaseCallbackProxy");
static_assert(offsetof(UInAppPurchaseCallbackProxy, OnSuccess) == 0x000030, "Member 'UInAppPurchaseCallbackProxy::OnSuccess' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FInAppPurchaseProductInfo>& InAppPurchaseInformation)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(TArray<struct FInAppPurchaseProductInfo>& InAppPurchaseInformation)> OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x48];                                      // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInAppPurchaseQueryCallbackProxy) == 0x000098, "Wrong size on UInAppPurchaseQueryCallbackProxy");
static_assert(offsetof(UInAppPurchaseQueryCallbackProxy, OnSuccess) == 0x000030, "Member 'UInAppPurchaseQueryCallbackProxy::OnSuccess' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseState CompletionStatus, TArray<struct FInAppPurchaseRestoreInfo>& InAppRestorePurchaseInformation)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(EInAppPurchaseState CompletionStatus, TArray<struct FInAppPurchaseRestoreInfo>& InAppRestorePurchaseInformation)> OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x48];                                      // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInAppPurchaseRestoreCallbackProxy) == 0x000098, "Wrong size on UInAppPurchaseRestoreCallbackProxy");
static_assert(offsetof(UInAppPurchaseRestoreCallbackProxy, OnSuccess) == 0x000030, "Member 'UInAppPurchaseRestoreCallbackProxy::OnSuccess' has a wrong offset!");
...
// 0x0060 (0x1A28 - 0x19C8)
class UIpConnection : public UNetConnection
{
public:
	uint8                                         Pad_19C8[0x50];                                    // 0x19C8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A1C[0xC];                                     // 0x1A1C(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001A28, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001A18, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
{
public:
	uint8                                         LogPortUnreach : 1;                                // 0x0778(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         AllowPlayerPortUnreach : 1;                        // 0x0778(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_779[0x3];                                      // 0x0779(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxPortCountToTry;                                 // 0x077C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_780[0xC];                                      // 0x0780(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        ServerDesiredSocketReceiveBufferBytes;             // 0x078C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ServerDesiredSocketSendBufferBytes;                // 0x0790(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketReceiveBufferBytes;             // 0x0794(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketSendBufferBytes;                // 0x0798(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_79C[0x4];                                      // 0x079C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        MaxSecondsInReceive;                               // 0x07A0(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NbPacketsBetweenReceiveTimeTest;                   // 0x07A8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UIpNetDriver) == 0x0007C0, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x00077C, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x00078C, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000790, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x000794, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000798, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x0007A0, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x0007A8, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
...
static_assert(sizeof(UJoinSessionCallbackProxy) == 0x000130, "Wrong size on UJoinSessionCallbackProxy");
...
static_assert(offsetof(ULeaderboardFlushCallbackProxy, OnSuccess) == 0x000030, "Member 'ULeaderboardFlushCallbackProxy::OnSuccess' has a wrong offset!");
...
static_assert(offsetof(ULeaderboardQueryCallbackProxy, OnSuccess) == 0x000030, "Member 'ULeaderboardQueryCallbackProxy::OnSuccess' has a wrong offset!");
...
{
public:
	class FName                                   VoiceSubsystemNameOverride;                        // 0x0030(0x000C)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3C[0xFC];                                      // 0x003C(0x00FC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOnlineEngineInterfaceImpl) == 0x000138, "Wrong size on UOnlineEngineInterfaceImpl");
static_assert(offsetof(UOnlineEngineInterfaceImpl, VoiceSubsystemNameOverride) == 0x000030, "Member 'UOnlineEngineInterfaceImpl::VoiceSubsystemNameOverride' has a wrong offset!");
...
static_assert(sizeof(UOnlinePIESettings) == 0x000060, "Wrong size on UOnlinePIESettings");
static_assert(offsetof(UOnlinePIESettings, bOnlinePIEEnabled) == 0x000048, "Member 'UOnlinePIESettings::bOnlinePIEEnabled' has a wrong offset!");
static_assert(offsetof(UOnlinePIESettings, Logins) == 0x000050, "Member 'UOnlinePIESettings::Logins' has a wrong offset!");
...
public:
	...
	class FString                                 DestSessionId;                                     // 0x0460(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x0470(0x0050)(Protected, NativeAccessSpecifierProtected)
	EClientRequestType                            RequestType;                                       // 0x04C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingReservationSent;                           // 0x04C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCancelReservation;                                // 0x04C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4C3[0x2D];                                     // 0x04C3(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconClient) == 0x0004F0, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x000460, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x000470, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x0004C0, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x0004C1, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x0004C2, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x03D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3D8[0x60];                                     // 0x03D8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0438(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_439[0x3];                                      // 0x0439(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x043C(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TravelSessionTimeoutSecs;                          // 0x0440(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APartyBeaconHost) == 0x000448, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x0003D0, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x000438, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x00043C, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x000440, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(offsetof(UPartyBeaconState, SessionName) == 0x000030, "Member 'UPartyBeaconState::SessionName' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumConsumedReservations) == 0x00003C, "Member 'UPartyBeaconState::NumConsumedReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, MaxReservations) == 0x000040, "Member 'UPartyBeaconState::MaxReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumTeams) == 0x000044, "Member 'UPartyBeaconState::NumTeams' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumPlayersPerTeam) == 0x000048, "Member 'UPartyBeaconState::NumPlayersPerTeam' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, TeamAssignmentMethod) == 0x00004C, "Member 'UPartyBeaconState::TeamAssignmentMethod' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, ReservedHostTeamNum) == 0x000058, "Member 'UPartyBeaconState::ReservedHostTeamNum' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, ForceTeamNum) == 0x00005C, "Member 'UPartyBeaconState::ForceTeamNum' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, bRestrictCrossConsole) == 0x000060, "Member 'UPartyBeaconState::bRestrictCrossConsole' has a wrong offset!");
...
static_assert(offsetof(UShowLoginUICallbackProxy, OnSuccess) == 0x000038, "Member 'UShowLoginUICallbackProxy::OnSuccess' has a wrong offset!");
...
public:
	uint8                                         Pad_430[0x30];                                     // 0x0430(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DestSessionId;                                     // 0x0460(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FSpectatorReservation                  PendingReservation;                                // 0x0470(0x0078)(Protected, NativeAccessSpecifierProtected)
	ESpectatorClientRequestType                   RequestType;                                       // 0x04E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingReservationSent;                           // 0x04E9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCancelReservation;                                // 0x04EA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4EB[0x2D];                                     // 0x04EB(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASpectatorBeaconClient) == 0x000518, "Wrong size on ASpectatorBeaconClient");
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x000460, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x000470, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x0004E8, "Member 'ASpectatorBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bPendingReservationSent) == 0x0004E9, "Member 'ASpectatorBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bCancelReservation) == 0x0004EA, "Member 'ASpectatorBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x03D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3D8[0x60];                                     // 0x03D8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0438(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_439[0x3];                                      // 0x0439(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SessionTimeoutSecs;                                // 0x043C(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASpectatorBeaconHost) == 0x000448, "Wrong size on ASpectatorBeaconHost");
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x0003D0, "Member 'ASpectatorBeaconHost::State' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, bLogoutOnSessionTimeout) == 0x000438, "Member 'ASpectatorBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, SessionTimeoutSecs) == 0x00043C, "Member 'ASpectatorBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, TravelSessionTimeoutSecs) == 0x000440, "Member 'ASpectatorBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(offsetof(USpectatorBeaconState, SessionName) == 0x000030, "Member 'USpectatorBeaconState::SessionName' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, NumConsumedReservations) == 0x00003C, "Member 'USpectatorBeaconState::NumConsumedReservations' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, MaxReservations) == 0x000040, "Member 'USpectatorBeaconState::MaxReservations' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, bRestrictCrossConsole) == 0x000044, "Member 'USpectatorBeaconState::bRestrictCrossConsole' has a wrong offset!");
static_assert(offsetof(USpectatorBeaconState, Reservations) == 0x000048, "Member 'USpectatorBeaconState::Reservations' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000430, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x0003D0, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0006E0, "Wrong size on UVoipListenerSynthComponent");
