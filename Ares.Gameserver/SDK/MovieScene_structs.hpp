...
public:
	...
	struct FMovieSceneSequenceTransform           RootToSequenceTransform;                           // 0x0020(0x000C)(NoDestructor, NativeAccessSpecifierPublic)
	struct FFrameRate                             TickResolution;                                    // 0x002C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneSequenceID                  DeterministicSequenceID;                           // 0x0034(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  PlayRange;                                         // 0x0038(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  PreRollRange;                                      // 0x0048(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  PostRollRange;                                     // 0x0058(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	int32                                         HierarchicalBias;                                  // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceInstanceDataPtr     InstanceData;                                      // 0x0070(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  SubSectionSignature;                               // 0x0090(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMovieSceneSequenceTransform           OuterToInnerTransform;                             // 0x00A0(0x000C)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_AC[0x4];                                       // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneSubSequenceData) == 0x000008, "Wrong alignment on FMovieSceneSubSequenceData");
static_assert(sizeof(FMovieSceneSubSequenceData) == 0x0000B0, "Wrong size on FMovieSceneSubSequenceData");
...
static_assert(offsetof(FMovieSceneSubSequenceData, TickResolution) == 0x00002C, "Member 'FMovieSceneSubSequenceData::TickResolution' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, DeterministicSequenceID) == 0x000034, "Member 'FMovieSceneSubSequenceData::DeterministicSequenceID' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PlayRange) == 0x000038, "Member 'FMovieSceneSubSequenceData::PlayRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PreRollRange) == 0x000048, "Member 'FMovieSceneSubSequenceData::PreRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PostRollRange) == 0x000058, "Member 'FMovieSceneSubSequenceData::PostRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, HierarchicalBias) == 0x000068, "Member 'FMovieSceneSubSequenceData::HierarchicalBias' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, InstanceData) == 0x000070, "Member 'FMovieSceneSubSequenceData::InstanceData' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, SubSectionSignature) == 0x000090, "Member 'FMovieSceneSubSequenceData::SubSectionSignature' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, OuterToInnerTransform) == 0x0000A0, "Member 'FMovieSceneSubSequenceData::OuterToInnerTransform' has a wrong offset!");
...
public:
	...
	class FName                                   FunctionName;                                      // 0x0020(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   NotifyFunctionName;                                // 0x002C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieScenePropertySectionData) == 0x000008, "Wrong alignment on FMovieScenePropertySectionData");
static_assert(sizeof(FMovieScenePropertySectionData) == 0x000038, "Wrong size on FMovieScenePropertySectionData");
...
static_assert(offsetof(FMovieScenePropertySectionData, FunctionName) == 0x000020, "Member 'FMovieScenePropertySectionData::FunctionName' has a wrong offset!");
static_assert(offsetof(FMovieScenePropertySectionData, NotifyFunctionName) == 0x00002C, "Member 'FMovieScenePropertySectionData::NotifyFunctionName' has a wrong offset!");
...
public:
	...
	class FName                                   EvaluationGroup;                                   // 0x00E8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bEvaluateInPreroll : 1;                            // 0x00F4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bEvaluateInPostroll : 1;                           // 0x00F4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(FMovieScenePropertySectionTemplate) == 0x000058, "Wrong size on FMovieScenePropertySectionTemplate");
