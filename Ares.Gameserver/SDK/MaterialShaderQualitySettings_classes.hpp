...
{
public:
	TMap<class FName, class UShaderPlatformQualitySettings*> ForwardSettingMap;                                 // 0x0030(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides[0x3];                             // 0x0030(0x0008)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
