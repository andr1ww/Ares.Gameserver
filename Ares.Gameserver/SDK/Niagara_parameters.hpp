...
public:
	...
	EAttachmentRule                               LocationRule;                                      // 0x0014(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               RotationRule;                                      // 0x0015(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               ScaleRule;                                         // 0x0016(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(NiagaraComponent_SetAutoAttachmentParameters, LocationRule) == 0x000014, "Member 'NiagaraComponent_SetAutoAttachmentParameters::LocationRule' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_SetAutoAttachmentParameters, RotationRule) == 0x000015, "Member 'NiagaraComponent_SetAutoAttachmentParameters::RotationRule' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_SetAutoAttachmentParameters, ScaleRule) == 0x000016, "Member 'NiagaraComponent_SetAutoAttachmentParameters::ScaleRule' has a wrong offset!");
...
static_assert(offsetof(NiagaraComponent_SetPreviewDetailLevel, bEnablePreviewDetailLevel_0) == 0x000000, "Member 'NiagaraComponent_SetPreviewDetailLevel::bEnablePreviewDetailLevel_0' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_SetPreviewDetailLevel, PreviewDetailLevel_0) == 0x000004, "Member 'NiagaraComponent_SetPreviewDetailLevel::PreviewDetailLevel_0' has a wrong offset!");
...
static_assert(offsetof(NiagaraComponent_SetPreviewLODDistance, bEnablePreviewLODDistance_0) == 0x000000, "Member 'NiagaraComponent_SetPreviewLODDistance::bEnablePreviewLODDistance_0' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_SetPreviewLODDistance, PreviewLODDistance_0) == 0x000004, "Member 'NiagaraComponent_SetPreviewLODDistance::PreviewLODDistance_0' has a wrong offset!");
