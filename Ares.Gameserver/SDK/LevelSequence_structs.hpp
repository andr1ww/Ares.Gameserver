...
static_assert(offsetof(FLevelSequencePlayerSnapshot, Settings) == 0x0000A0, "Member 'FLevelSequencePlayerSnapshot::Settings' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ActiveShot) == 0x0000B0, "Member 'FLevelSequencePlayerSnapshot::ActiveShot' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x0000B8, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
