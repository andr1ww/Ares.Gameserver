...
{
public:
	class UDestructibleComponent*                 DestructibleComponent;                             // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bAffectNavigation : 1;                             // 0x03B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_3B1[0x7];                                      // 0x03B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(struct FVector& HitPoint, struct FVector& HitDirection)> OnActorFracture;                                   // 0x03B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADestructibleActor) == 0x0003C8, "Wrong size on ADestructibleActor");
static_assert(offsetof(ADestructibleActor, DestructibleComponent) == 0x0003A8, "Member 'ADestructibleActor::DestructibleComponent' has a wrong offset!");
static_assert(offsetof(ADestructibleActor, OnActorFracture) == 0x0003B8, "Member 'ADestructibleActor::OnActorFracture' has a wrong offset!");
...
public:
	...
	uint8                                         bFractureEffectOverride : 1;                       // 0x0708(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	TMulticastInlineDelegate<void(struct FVector& HitPoint, struct FVector& HitDirection)> OnComponentFracture;                               // 0x0738(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_748[0x98];                                     // 0x0748(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDestructibleComponent) == 0x0007E0, "Wrong size on UDestructibleComponent");
static_assert(offsetof(UDestructibleComponent, FractureEffects) == 0x000710, "Member 'UDestructibleComponent::FractureEffects' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, bEnableHardSleeping) == 0x000720, "Member 'UDestructibleComponent::bEnableHardSleeping' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, LargeChunkThreshold) == 0x000724, "Member 'UDestructibleComponent::LargeChunkThreshold' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x000738, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
...
{
public:
	struct FDestructibleParameters                DefaultDestructibleParameters;                     // 0x0368(0x0088)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x03F0(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDestructibleMesh) == 0x000408, "Wrong size on UDestructibleMesh");
...
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x0003F0, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
