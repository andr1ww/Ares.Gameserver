...
static_assert(sizeof(LobbyBeaconClient_ClientLoginComplete) == 0x000030, "Wrong size on LobbyBeaconClient_ClientLoginComplete");
...
static_assert(offsetof(LobbyBeaconClient_ClientLoginComplete, bWasSuccessful) == 0x000028, "Member 'LobbyBeaconClient_ClientLoginComplete::bWasSuccessful' has a wrong offset!");
...
static_assert(sizeof(LobbyBeaconClient_ClientPlayerLeft) == 0x000028, "Wrong size on LobbyBeaconClient_ClientPlayerLeft");
...
static_assert(offsetof(LobbyBeaconClient_ServerKickPlayer, Reason) == 0x000028, "Member 'LobbyBeaconClient_ServerKickPlayer::Reason' has a wrong offset!");
...
static_assert(sizeof(LobbyBeaconClient_ServerLoginPlayer) == 0x000048, "Wrong size on LobbyBeaconClient_ServerLoginPlayer");
...
static_assert(offsetof(LobbyBeaconClient_ServerLoginPlayer, UrlString) == 0x000038, "Member 'LobbyBeaconClient_ServerLoginPlayer::UrlString' has a wrong offset!");
...
static_assert(sizeof(LobbyBeaconClient_ServerSetPartyOwner) == 0x000050, "Wrong size on LobbyBeaconClient_ServerSetPartyOwner");
...
static_assert(offsetof(LobbyBeaconClient_ServerSetPartyOwner, InPartyOwnerId) == 0x000028, "Member 'LobbyBeaconClient_ServerSetPartyOwner::InPartyOwnerId' has a wrong offset!");
